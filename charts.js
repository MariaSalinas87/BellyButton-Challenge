...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var MetadataArray = filteredMetadata[0];
    ...
    // Plotly.newPlot("cbar", trace1, barChartLayout);
